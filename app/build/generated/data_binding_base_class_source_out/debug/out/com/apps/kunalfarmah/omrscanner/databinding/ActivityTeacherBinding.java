...
public final class ActivityTeacherBinding implements ViewBinding {
  ...
  private ActivityTeacherBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listItem) {
  ...
  public static ActivityTeacherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTeacherBinding((ConstraintLayout) rootView, listItem);
    }
